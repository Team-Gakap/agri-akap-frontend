...
const routes: Array<RouteRecordRaw> = [
  ...
  // ── Admin environment (web / desktop, sidebar) ────────────────────────────
  {
    ...
    children: [
      ...
      { path: "reports/standing-crop", name: "ReportStandingCrop", component: () => import("@/views/Admin/Reports/StandingCropReportView.vue"), meta: { title: "Standing Crop" } },
  ...
  // ── Barangay Portal (desktop encoding + damage review) ────────────────────
  {
    ...
    children: [
      ...
      { path: "reports/standing-crop", name: "BrgyReportStandingCrop", component: () => import("@/views/Admin/Reports/StandingCropReportView.vue"), meta: { title: "Standing Crop" } },
