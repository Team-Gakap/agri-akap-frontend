...
const routes: Array<RouteRecordRaw> = [
  ...
  // ── Barangay Portal (desktop encoding + damage review) ────────────────────
  {
    ...
    children: [
      ...
      { path: "reports/subsidies", name: "BrgyReportSubsidies", component: () => import("@/views/Admin/Reports/SubsidyReportView.vue") },
      { path: "reports/crop-production", name: "BrgyReportCropProduction", component: () => import("@/views/Admin/Reports/CropProductionReportView.vue") },
      { path: "reports/standing-crop", name: "BrgyReportStandingCrop", component: () => import("@/views/Admin/Reports/StandingCropReportView.vue") },
      { path: "reports/pest-surveillance", name: "BrgyReportPest", component: () => import("@/views/Admin/Reports/PestReportView.vue") },
      { path: "reports/damage-calamity", name: "BrgyReportDamage", component: () => import("@/views/Admin/Reports/DamageReportView.vue") },
