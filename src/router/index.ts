...
const routes: Array<RouteRecordRaw> = [
  ...
  // ── Barangay Portal (desktop encoding + damage review) ────────────────────
  {
    ...
    children: [
      ...
      { path: "damage-review", name: "BrgyDamageReview", component: () => import("@/views/Damage/DamageReviewPage.vue") },
      { path: "weather-hub", name: "BrgyWeatherHub", component: () => import("@/views/Barangay/BrgyWeatherHubView.vue") },
