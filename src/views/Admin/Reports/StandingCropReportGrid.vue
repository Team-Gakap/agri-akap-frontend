<template>
  <div class="rpt-shell standing-grid">
...
async function downloadExcel() {
  await exportAdminGridExcel({
    ...
    reportTitle: 'Crop Production Report (Standing Data)',
...
.filter-input { width: 130px; min-width: 130px; }
...
.grid-shell { background: #fff; border: 1px solid #cbd5e1; border-radius: 8px; overflow: hidden; flex: 1; min-height: 0; display: flex; flex-direction: column; }
...
@media print {
  ...
  .standing-grid, .grid-shell, .table-scroll, .print-surface {
